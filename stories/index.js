...
storiesOf("DayListItem", module) 
  ...
  storiesOf("Appointment", module)
    ...
    .add("Error", () => <Error message="" onClose={action("onClose"
    )} />)
    .add("Form Create", () => <Form interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
    .add("Form Edit", () => <Form student="Zeinab" interviewer={4} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
